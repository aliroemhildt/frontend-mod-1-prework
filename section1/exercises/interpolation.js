...
// Your answer and explanation here: String. Interpolation embeds values into a string, so
...
var race = '100 meter dash';
var athlete = 'Lucy';
var place = 1;
console.log(`${athlete} placed ${place}st in the ${race}`);
