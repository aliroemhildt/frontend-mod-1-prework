...
I was able to use a logical operator in my last if statement, since we are using two variables.
I read about logical operators before completing this excercise, so I was familiar with the
&& and || operators.

&& returns true when both operands are true
|| returns false when both operands are false
*/
